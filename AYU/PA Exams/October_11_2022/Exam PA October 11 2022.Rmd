...
# Add code to create values needed for RMSE calculation.
...
# Candidate will add code where indicated.

# Read in the data for the task.
var_classes <- c('numeric', 'factor','factor')
df.mixed.pickups <- read.csv("mixed_pickups.csv",colClasses=var_classes)

# ------------- Candidate code -------------------------
# Use the space below for code to make a graph that shows the trend of 
# resolution times over the years, split by department type.





# Copy the graph you produced above to the Word document.
#-------------------------------------------------------------------------------
